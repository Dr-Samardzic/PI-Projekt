...
public class FriendsProfilePanel extends JPanel {
	...
	static JList<String> friendsWishlist;
	...
	protected static String itemPrice;
	protected static String itemLink;
	...
	public void getDataFromSelected() {
		try {
			// Open connection
			...
			String sql = "select * from giftyDB.wishlist where itemName = '"+selectedItem+"'";
			
			ResultSet rs = stmt.executeQuery(sql);
			
			if (rs.next()){
					
				itemId = rs.getString("idWishlistItem");
				itemName = rs.getString("itemName");
				itemPrice = rs.getString("itemPrice");
				itemLink = rs.getString("itemLink");
				itemCurrency = rs.getString("itemCurrency");
			}
