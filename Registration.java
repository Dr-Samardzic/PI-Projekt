...
public class Registration extends JFrame {
	...
	public Registration() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
	        	    ...
	        	    if (passwordInput.equals(rePasswordInput)) {
						...
						String sql = "Insert into users (firstName, lastName, email, username, password) values ('"+ firstNameInput +"', '"+ lastNameInput +"', "
		...
		btnSignIn.setBounds(182, 271, 100, 30);
		...
		goBackLabel.setBounds(54, 6, 202, 60);
		...
		registrationTextPanel.add(btnSignIn);
		
		//Add components on right side
